...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	String branch = "Кафедра програмних систем і технологій";
	String year = "ІПЗ";
	String subject = "SC";

	private String[] branchString = new String[] { "Кафедра програмних систем і технологій"};
	private String[] yearString = new String[] {"ІПЗ-41","ІПЗ-42","ІПЗ-43"};
	private String[] subjectSEString = new String[] {"ППМП","MC"};
	private String[] subjectTEString = new String[] {"GT","CN"};
	private String[] subjectBEString = new String[] {"DS","NS"};

	private String[] subjectFinal = new String[] {"ХТ","КП","ППМП","ПБД","КМТТ","ООП"};
